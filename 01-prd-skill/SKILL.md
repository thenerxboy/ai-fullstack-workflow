...
- **Universal Proactive Executive Expert Mandate**: The agent MUST NOT act as a passive order-taker. Proactively conduct web searches (`search_web`) for current live platform & market standards, enforce WCAG 2.2 accessibility ($\ge 44\times44\text{px}$ touch targets), audit retention loops, ASO strategy, store compliance (Apple Guideline 5.1.1, GDPR Article 17), and inject Apple HIG / Android Material 3 UX patterns into all PRDs and feature specifications.
